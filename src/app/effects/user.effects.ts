...
export class UserEffects {
  ...
  getUser: Observable<Action> = this.actions
    .pipe(ofType(userActions.GET_USER))
  ...
  login: Observable<Action> = this.actions
    .pipe(ofType(userActions.GOOGLE_LOGIN))
  ...
  authenticated: Observable<Action> = this.actions
    .pipe(ofType(userActions.AUTHENTICATED))
  ...
  updateProfile: Observable<Action> = this.actions
    .pipe(ofType(userActions.UPDATE_PROFILE))
  ...
  firstLogin: Observable<Action> = this.actions
    .pipe(ofType(userActions.FIRST_LOGIN))
  ...
  @Effect({ dispatch: false })
  logOut: Observable<Action> = this.actions
    .pipe(ofType(userActions.LOGOUT, userActions.UPDATE_PROFILE_SUCCESS))
    .map(
      (action: userActions.Logout | userActions.UpdateProfileSuccess) =>
        action.payload
    )
    .switchMap(payload => {
